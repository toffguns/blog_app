...
RSpec.describe ArticlesController, type: :controller do
  ...
  describe "GET #edit" do
    ...
    context "non-owner should not be allowed to edit other users articles" do
      it "redirects to root path" do
        fred = User.create(email: "fred@example.com", password: "password")
        
        login_user fred
        
        article = Article.create(title: "first article", body: 'The body of first article', user: @john)
